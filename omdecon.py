...
#AIDA 1.41. For now deconr is not using the 3D capabilities of AIDA as 3D tif reading is broken in v1.41.
import aida.AIDA as AIDA
	
#Need to install Christoph Gohlke's PSF.py module for this (http://www.lfd.uci.edu/~gohlke/). 
#Instructions to build the extension module available in psf.c .
#if on Windows, pip install might work.
import psf
...
def runAsScript():
	...
	client = scripts.client('deconr',
	"""Omdecon: deconvolution on the OMERO server.
	
	Omdecon uses AIDA, the Adaptative Image Deconvolution Algorithm, to deconvolve your images. 
	...
	More info: http://www.lfd.uci.edu/~gohlke/
	...
	""",
		...
		version="0.1.0",
		authors=["deconr: Etienne Labrie-Dion", "AIDA: E.Hom, S. Haase, C. Chalumeau, F. Marchis", "PSF: C. Gohlke"],
